                    ...
                    <div className="container">
                        ...
                        <div className="freshBrewsFilter">
                            <ul className="FreshBrews-nav">
                                ...
                                <li>
                                    <a href="#" data-filter=".branding">With milk</a>
                                </li>
                                <li>
                                    <a href="#" data-filter=".webdesign">Syrup-y concoctions</a>
                                </li>
                                <li>
                                    <a href="#" data-filter=".printdesign">Specials</a>
                                </li>
                                <li>
                                    <a href="#" data-filter=".photography">Pony dust</a>
                                </li>
                            </ul>
                        </div>
                    </div>
